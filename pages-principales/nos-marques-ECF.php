...
<body>
    ...
    <nav class="nav">
        ...
        <h1>Nos marques:</h1>
    <span>
        <p>Notre garage est spécialisé dans les marques française et propose une séléction de véhicules neuf et occasion parmis eux.</p>
    <br>
        <p>Les marques que nous vendons sont:</p>
    <br>
        <p>Bugatti:</p>
